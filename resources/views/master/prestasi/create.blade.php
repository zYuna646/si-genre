...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-elephant-900">Tambah Prestasi Anggota: {{ $anggota->nama }}</h1>
        <p class="text-gray-600">Tambahkan prestasi baru untuk anggota ini</p>
    </div>

    <x-form-section title="Data Prestasi" submit="{{ route('master.prestasi.store', ['anggota_id' => $anggota->id]) }}" enctype="multipart/form-data">
