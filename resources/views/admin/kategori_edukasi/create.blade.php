...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-elephant-900">Tambah Kategori Edukasi</h1>
        <p class="text-gray-600">Buat kategori baru untuk konten edukasi</p>
    </div>

    <x-form-section title="Data Kategori" submit="{{ route('master.kategori_edukasi.store') }}">
